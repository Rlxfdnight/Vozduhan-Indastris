...
/* ---- Генератор ---- */
const PHRASES = [
  'Воздух — это не газ. Это стратегия.',
  'Плотность 99.97%: остальное — скромность наших инженеров.',
  'Не ждите ветра — становитесь ветром.',
  'Каждый вздох должен быть сертифицирован ООО «Воздух».',
  'Хайп сжимаем, смыслы разжижаем, воздух поставляем.',
  'Вентиляция — это диалог помещения с вечностью.',
  'Гоните воздух качественно — и он пригонит вам аудиторию.',
  'Настоящий воздух слышно, а не видно.',
  'Где пахнет жареным — там недоработка вытяжки.',
  'План по воздуху перевыполняется строго по графику.'
];
